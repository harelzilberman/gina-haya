...
exports.isLocalPhotoPath = isLocalPhotoPath;
exports.assertStorageKey = assertStorageKey;
 ...
 */
function isLocalPhotoPath(photoPath) {
 ...
 */
function assertStorageKey(photoPath, field = 'photo_path') {
    if (isLocalPhotoPath(photoPath)) {
        throw new Error(`${field} must be a Supabase storage key (e.g. "<user_id>/chupchu/<timestamp>.jpg"), ` +
