    ...
    <div ref={ref} style={{ position: 'relative' }}>
      <button
        ...
        style={{
          ...
          color: PARCH, background: 'rgba(245,200,64,0.08)',
        ...
        onMouseEnter={e => {
          ...
          (e.currentTarget as HTMLElement).style.background = 'rgba(245,200,64,0.12)';
        }}
        onMouseLeave={e => {
          (e.currentTarget as HTMLElement).style.borderColor = 'rgba(245,200,64,0.2)';
      ...
      {open && (
        <div style={{
          ...
          {/* Header */}
          <div style={{ padding: '8px 14px 6px', borderBottom: '1px solid rgba(245,200,64,0.08)', marginBottom: '4px' }}>
            <span style={{ fontFamily: FRANK, fontSize: '12px', color: `${PARCH}60`, letterSpacing: '0.05em' }}>
              הגינות שלי
            </span>
          </div>
            ...
            return (
              ...
              >
                ...
                <div style={{ flex: 1, textAlign: 'start', overflow: 'hidden' }}>
                  ...
                  {garden.location && (
                    <div style={{ fontFamily: ASST, fontSize: '11px', color: `${PARCH}55`, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {garden.location}
                    </div>
                  )}
                </div>
          ...
          {/* Footer */}
          <div style={{ borderTop: '1px solid rgba(245,200,64,0.08)', marginTop: '4px', padding: '6px 8px' }}>
            {!atLimit ? (
              <button
                onClick={() => { onCreateGarden(); setOpen(false); }}
                style={{
                  width: '100%', padding: '8px 10px',
                  background: 'rgba(245,200,64,0.1)', border: '1px dashed rgba(245,200,64,0.3)',
                  borderRadius: '6px', cursor: 'pointer',
                  fontFamily: ASST, fontSize: '12px', fontWeight: 600, color: GOLD,
                  display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px',
                  transition: 'background 0.15s, border-color 0.15s',
                }}
                onMouseEnter={e => {
                  (e.currentTarget as HTMLElement).style.background = 'rgba(245,200,64,0.16)';
                  (e.currentTarget as HTMLElement).style.borderColor = 'rgba(245,200,64,0.6)';
                }}
                onMouseLeave={e => {
                  (e.currentTarget as HTMLElement).style.background = 'rgba(245,200,64,0.1)';
                  (e.currentTarget as HTMLElement).style.borderColor = 'rgba(245,200,64,0.3)';
                }}
              >
                + הוסף גינה
              </button>
              ...
              <button
                ...
                style={{
                  width: '100%', padding: '8px 10px',
                  background: 'transparent', border: '1px solid rgba(245,200,64,0.2)',
                  borderRadius: '6px', cursor: 'pointer',
                  fontFamily: ASST, fontSize: '11px', color: `${PARCH}70`,
            ...
            <button
              ...
              style={{
                width: '100%', padding: '7px 10px', marginTop: '4px',
                background: 'transparent', border: 'none', cursor: 'pointer',
                fontFamily: ASST, fontSize: '11px', color: `${PARCH}50`,
