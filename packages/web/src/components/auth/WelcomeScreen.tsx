...
@keyframes chupchu-glow {
  0%, 100% { box-shadow: 0 0 28px rgba(245,200,64,0.35), 0 0 8px rgba(245,200,64,0.18); }
  50%       { box-shadow: 0 0 56px rgba(245,200,64,0.65), 0 0 20px rgba(245,200,64,0.4); }
}
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          background: 'linear-gradient(180deg, #070f07 0%, #142B16 55%, #0a1a0c 100%)',
