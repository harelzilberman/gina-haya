...
const GOLD  = '#F5C840';
const SAGE  = '#7DC084';
const TEXT  = 'rgba(237,224,196,0.8)';
...
@keyframes pulse {
  0%, 100% { box-shadow: 0 0 0 0 rgba(245,200,64,0.4); }
  50%       { box-shadow: 0 0 0 8px rgba(245,200,64,0); }
}
@keyframes slideUp {
    ...
    <div style={{ position: 'relative', paddingBottom: '20px' }}>
      <div style={{ display: 'flex', gap: '12px', alignItems: 'center', marginBottom: '10px' }}>
        <div className="hp-pulse" style={{
          ...
          background: 'radial-gradient(circle at 38% 38%, #FFF0A0, #F5C840, #C8960A)',
          boxShadow: '0 0 16px rgba(245,200,64,0.3)',
        }} />
        <div style={{
          flex: 1, borderRadius: '10px', padding: '9px 13px',
          background: 'rgba(125,192,132,0.1)',
          border: '1px solid rgba(125,192,132,0.25)',
        }}>
          <div style={{ fontFamily: ASST, fontSize: '10px', color: 'rgba(237,224,196,0.4)', marginBottom: '3px' }}>סוג היום</div>
  ...
  return (
    <div style={{ position: 'relative', paddingBottom: '20px' }}>
      <div style={{
        ...
        background: 'rgba(26,58,28,0.7)', borderRadius: '8px', padding: '5px 8px',
        border: '1px solid rgba(245,200,64,0.08)',
      }}>
        {['🖊️ עט', '🌿 צמח', '🏠 מבנה', '🛣️ שביל'].map(t => (
          <div key={t} style={{
            fontFamily: ASST, fontSize: '11px', color: TEXT,
            background: 'rgba(245,200,64,0.07)', borderRadius: '5px',
      ...
      <div style={{
        ...
        background: 'rgba(125,192,132,0.06)',
    ...
    <div style={{ position: 'relative', paddingBottom: '20px' }}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '8px' }}>
        <div style={{ alignSelf: 'flex-end', maxWidth: '72%' }}>
          <div style={{
            fontFamily: ASST, fontSize: '13px', color: '#142B16',
        ...
        <div style={{ alignSelf: 'flex-start', maxWidth: '78%', display: 'flex', gap: '7px', alignItems: 'flex-end' }}>
          <div style={{
            ...
            background: 'radial-gradient(circle, #F5D060, #F5C840)',
          ...
          <div style={{
            ...
            background: 'rgba(26,58,28,0.9)', border: '1px solid rgba(245,200,64,0.12)',
      ...
      <div style={{
        ...
        background: 'rgba(26,58,28,0.7)', borderRadius: '8px', padding: '7px 10px',
        border: '1px solid rgba(245,200,64,0.08)',
      }}>
        <div style={{ flex: 1, fontFamily: ASST, fontSize: '13px', color: 'rgba(237,224,196,0.3)' }}>שאל שאלה...</div>
  ...
  return (
    <div style={{ position: 'relative', paddingBottom: '20px' }}>
      <div style={{
        ...
        background: 'rgba(26,58,28,0.5)',
        border: '2px dashed rgba(245,200,64,0.2)',
        textAlign: 'center', marginBottom: '10px',
      }}>
        <div style={{ fontSize: '28px', marginBottom: '4px' }}>📸</div>
        <div style={{ fontFamily: ASST, fontSize: '12px', color: 'rgba(237,224,196,0.4)' }}>לחץ לצילום צמח</div>
      </div>
      <div style={{ display: 'flex', gap: '7px' }}>
        {[
          ...
          <div key={c.label} style={{
            ...
            background: 'rgba(26,58,28,0.8)',
            border: `1px solid ${c.color}33`, textAlign: 'center',
          }}>
            <div style={{ fontFamily: ASST, fontSize: '10px', color: 'rgba(237,224,196,0.4)', marginBottom: '2px' }}>{c.label}</div>
        ...
        {tasks.map((t, i) => (
          <div key={i} style={{
            ...
            <span style={{
              ...
              color: t.done ? 'rgba(237,224,196,0.35)' : TEXT,
      ...
      <div style={{ maxWidth: '560px', margin: '0 auto', padding: '36px 20px 72px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <div style={{
            ...
            overflow: 'hidden', boxShadow: '0 0 24px rgba(245,200,64,0.3)',
          }}>
            <img
          ...
          <p style={{ fontFamily: ASST, fontSize: '14px', color: 'rgba(237,224,196,0.5)', margin: 0 }}>
          ...
          {STEPS.map((s, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: '4px',
                background: i === step ? GOLD : 'rgba(245,200,64,0.22)',
                cursor: 'pointer',
        ...
        <div key={step} className="hp-slide">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
            ...
            <span style={{
              ...
              background: 'rgba(245,200,64,0.1)', color: 'rgba(245,200,64,0.7)',
        ...
        <div style={{ display: 'flex', gap: '10px', marginTop: '22px' }}>
          {step > 0 && (
            <button
              ...
              style={{
                ...
                border: '1px solid rgba(245,200,64,0.28)',
                background: 'transparent', color: GOLD,
                cursor: 'pointer', transition: 'background 0.2s',
              }}
              onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = 'rgba(245,200,64,0.07)'; }}
          ...
          <button
            ...
            style={{
              ...
              padding: '12px 22px', borderRadius: '8px',
              border: 'none', background: GOLD, color: '#142B16',
              cursor: 'pointer',
