...
const SECTIONS = [
  ...
  },
  {
    ...
    body: 'המידע שלך משמש אך ורק לאספקת השירות — לוח הביודינמי האישי, שיחות עם מון לבנה, וניהול הגינה. איננו מוכרים או חולקים את המידע שלך עם צדדים שלישיים לצורכי פרסום.',
  },
  {
    title: 'אחסון נתונים',
  ...
  },
  {
    ...
    body: 'אם נשנה מדיניות זו בצורה מהותית, נשלח הודעה בדוא"ל ונציין את תאריך העדכון בראש הדף. המשך השימון לאחר השינוי מהווה הסכמה למדיניות המעודכנת.',
  },
  {
    title: 'יצירת קשר',
