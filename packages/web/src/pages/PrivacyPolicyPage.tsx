...
const SECTIONS = [
  ...
  },
  {
    ...
    body: 'המידע שלך משמש אך ורק לאספקת השירות — לוח הביודינמי האישי, שיחות עם צ\'אפצ\'ו, וניהול הגינה. איננו מוכרים או חולקים את המידע שלך עם צדדים שלישיים לצורכי פרסום.',
  },
  {
    title: 'אחסון נתונים',
