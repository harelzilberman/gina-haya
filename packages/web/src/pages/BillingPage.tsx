...
const TIER_FEATURES_HE: Record<string, string[]> = {
  free:         ['לוח ביודינמי יומי', 'אנציקלופדיית צמחים', 'גינה אחת', 'שיחה עם מון (20/חודש)', 'פרסומות'],
  grower:       ['גישה מלאה לאפליקציה', '5 אבחנות צמחים / חודש', 'שיחה עם מון (50/חודש)'],
  gardener_pro: ['ללא פרסומות', 'אבחנות ללא הגבלה', 'שיחה עם מון ללא הגבלה', 'גינות מרובות'],
